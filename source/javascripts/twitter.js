...
function showTwitterFeed(tweets, twitter_user) {
  ...
  for (var t in tweets) {
    content += '<li>'+'<p>'+'<a href="https://twitter.com/'+twitter_user+'/status/'+tweets[t].id_str+'"><i class="icon-twitter-sign"></i> <span class="label secondary round">'+prettyDate(tweets[t].created_at)+' ago</span></a> '+linkifyTweet(tweets[t].text.replace(/\n/g, '<br>'), tweets[t].entities.urls)+'</p>'+'</li>';
  }
